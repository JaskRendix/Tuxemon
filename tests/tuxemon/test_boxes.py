...
class TestMonsterBoxes(unittest.TestCase):
    ...
    def test_move_monsters(self):
        self.monster_boxes.add_monster(self.box_id1, self.monster1)
        self.monster_boxes.add_monster(self.box_id1, self.monster2)
        self.monster_boxes.move_monsters(self.box_id1, self.box_id2)
    ...
    def test_swap_monsters(self):
        self.monster_boxes.add_monster(self.box_id1, self.monster1)
        self.monster_boxes.add_monster(self.box_id2, self.monster2)
        self.monster_boxes.swap_monsters(
            self.box_id1, self.box_id2, self.monster1, self.monster2
        )
        self.assertEqual(
            self.monster_boxes.get_monsters(self.box_id1), [self.monster2]
        )
        self.assertEqual(
            self.monster_boxes.get_monsters(self.box_id2), [self.monster1]
        )
